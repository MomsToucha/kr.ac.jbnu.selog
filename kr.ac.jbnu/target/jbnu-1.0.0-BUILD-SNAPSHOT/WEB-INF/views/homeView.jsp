        ...
        <div class="header-hidden-inner container">
          <div class="row">
            <div class="col-md-3">
              ...
              <p>Blues give you a chance to get your private stories be stored safely and share experience if you want.</p>
            ...
            <div class="col-md-3">
              ...
              <address>
                  <strong>Blues Private Blog Platform</strong>
                  <abbr title="Address"><i class="fa fa-pushpin"></i></abbr>
                  313-1, Software Engineering Department, JBNU, JeonJu, Republic Of Korea.
                  <br>
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="navbar-slogan">
                Responsive private Space
                <br> By JBNU Dream_Team
              </div>
            </div>
            <!--header rightside-->
            <div class="col-md-4">
            ...
            <ul class="nav navbar-nav" id="main-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown-header">BLUES</li>
              ...
              <li class="dropdown dropdown-mm">
                ...
                <ul class="dropdown-menu dropdown-menu-mm dropdown-menu-persist">
                  ...
                  <li class="dropdown-footer">
                    <div class="row">
                      <div class="col-md-7">Aren't you satisfying yet? <strong>Get how to use properly our BLUES</strong></div>
                      <div class="col-md-5">
                        <a href="about" class="btn btn-more btn-lg pull-right"><i class="fa fa-cloud-download"></i> Get It Now</a>
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div class="row">
                <div class="col-md-6 col-md-push-6 item-caption">
                  <h2 class="h1 text-weight-light">
                      Welcome to <span class="text-primary">BLUES</span>
                    </h2>
                  <h4>
                      Perfect
                    </h4>
            ...
            <div class="item">
              <div class="row">
                <div class="col-md-6 text-right-md item-caption">
                  <h2 class="h1 text-weight-light">
                      <span class="text-primary">Blues</span> Private Blog Platform
                    </h2>
                  <h4>
                      High quality of Blog operating Environment will be offered.
                    </h4>
                  <p>Kim se min ba bo</p>
      ...
      <div class="row" id="contact">
        ...
        <div class="col-md-3">
          <address>
              ...
              <br>
              <i class="fa fa-phone fa-fw text-primary"></i> 010-9893-3023
              <br>
              <i class="fa fa-envelope-o fa-fw text-primary"></i> shak5643@gmail.com	
              <br>
            </address>
        </div>
