...
public class Post {
	...
	public void setPost_date(String datetime) {
	...
	public String toString() {
		return "Post's key_info =" + post_key + "post_title = " + post_title + "post_content = " + post_content + "post_date = " + post_date + "post_visible = " + post_visible + "post_owner = " + post_owner;
	}
